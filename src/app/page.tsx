...
const InsightDetailView = ({ title, onClose, theme, predictionSlider, onSliderChange, predictionLabel, children }) => (
...
const NewbieInfo = () => <InsightsTab theme="dark" />;
